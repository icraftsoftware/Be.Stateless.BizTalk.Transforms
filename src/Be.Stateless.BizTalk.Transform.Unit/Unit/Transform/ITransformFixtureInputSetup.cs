...
namespace Be.Stateless.BizTalk.Unit.Transform
{
	...
	public interface ITransformFixtureInputSetup : IFluentInterface
	{
		...
		ITransformFixtureInputSetup Message(System.IO.Stream message);

		ITransformFixtureInputSetup Message<TSchema>(System.IO.Stream message)
			where TSchema : SchemaBase, new();

		[SuppressMessage("ReSharper", "UnusedMemberInSuper.Global", Justification = "Public API.")]
		ITransformFixtureInputSetup Message<TSchema>(System.IO.Stream message, XmlSchemaContentProcessing contentProcessing)
			where TSchema : SchemaBase, new();
	}
}
